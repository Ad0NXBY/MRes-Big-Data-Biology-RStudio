...
Volcano_Plot_Plenti_v_KO22 <- ggplot(volcano_data_22, aes(x = log2FoldChange, y = -log10(padj), color = Significance, label = Gene)) +
  ...
  geom_text(data = top_upregulated_22, aes(label = GeneSymbol), vjust = 1, hjust = 1, size = 3, color = "red", check_overlap = TRUE) + #Red for upregulated
  geom_text(data = top_downregulated_22, aes(label = GeneSymbol), vjust = 1, hjust = 1, size = 3, color = "blue", check_overlap = TRUE) + #Blue for downregulated
...
Volcano_Plot_Plenti_v_KO23 <- ggplot(volcano_data_23, aes(x = log2FoldChange, y = -log10(padj), color = Significance, label = Gene)) +
  ...
  geom_text(data = top_upregulated_23, aes(label = GeneSymbol), vjust = 1, hjust = 1, size = 3, color = "red", check_overlap = TRUE) +
  geom_text(data = top_downregulated_23, aes(label = GeneSymbol), vjust = 1, hjust = 1, size = 3, color = "blue", check_overlap = TRUE) +
