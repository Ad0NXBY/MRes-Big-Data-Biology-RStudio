plot_dir <- "Analysis_plots with ChenYin data and code"
data_dir <- "List_for_analysis with ChenYin data and code"
...
# Read files
Control1 <- fread("C:/Users/Brandon/Documents/MRes Big Data Biology/Data analysis/DATA FROM CHENYIN/Ch_A1.txt")
Control2 <- fread("C:/Users/Brandon/Documents/MRes Big Data Biology/Data analysis/DATA FROM CHENYIN/Ch_A2.txt")
Control3 <- fread("C:/Users/Brandon/Documents/MRes Big Data Biology/Data analysis/DATA FROM CHENYIN/Ch_A3.txt")
FIH22KO1 <- fread("C:/Users/Brandon/Documents/MRes Big Data Biology/Data analysis/DATA FROM CHENYIN/Ch_B1.txt")
FIH22KO2 <- fread("C:/Users/Brandon/Documents/MRes Big Data Biology/Data analysis/DATA FROM CHENYIN/Ch_B2.txt")
FIH22KO3 <- fread("C:/Users/Brandon/Documents/MRes Big Data Biology/Data analysis/DATA FROM CHENYIN/Ch_B3.txt")
FIH23KO1 <- fread("C:/Users/Brandon/Documents/MRes Big Data Biology/Data analysis/DATA FROM CHENYIN/Ch_C1.txt")
FIH23KO2 <- fread("C:/Users/Brandon/Documents/MRes Big Data Biology/Data analysis/DATA FROM CHENYIN/Ch_C2.txt")
FIH23KO3 <- fread("C:/Users/Brandon/Documents/MRes Big Data Biology/Data analysis/DATA FROM CHENYIN/Ch_C3.txt")
...
# 读取已经标准化的数据
Ch_data <- read.csv("C:/Users/Brandon/Documents/MRes Big Data Biology/R studio/List_for_analysis with ChenYin data and code/normalized_counts.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
rownames(Ch_data) <- Ch_data$X
Ch_data <- Ch_data[, -1]


Ch_data <- read.csv("C:/Users/Brandon/Documents/MRes Big Data Biology/R studio/List_for_analysis with ChenYin data and code/normalized_counts.csv", 
                    header=TRUE, sep=",", stringsAsFactors=FALSE)
rownames(Ch_data) <- Ch_data$X
Ch_data <- Ch_data[, -1]  # Remove the first column (gene names are now in rownames)
...
rnk_FIH22KO <- results_FIH22KO_df[, c("gene", "log2FoldChange")]
...
grnk_FIH22KO <- results_FIH22KO_df[!is.na(results_FIH22KO_df$padj) & results_FIH22KO_df$padj < 0.05, c("gene", "log2FoldChange")]
rnk_FIH22KO <- rnk_FIH22KO[order(rnk_FIH22KO$log2FoldChange, decreasing = TRUE), ]
write.table(rnk_FIH22KO, file.path(data_dir, "DEG_FIH22KO_vs_Control.rnk"),
            sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
# Create a ranked list file for GSEA (using log2FoldChange as the ranking metric)
rnk_FIH23KO <- results_FIH23KO_df[, c("gene", "log2FoldChange")]
